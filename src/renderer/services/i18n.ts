...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    confirmDeleteCustomProvider: '确定删除此本地模型配置？',
    import: '导入',
    export: '导出',
    ...
    authPromoSubscriptionFloatAction: '确定',
    authZeroCredits: '0积分',
    planFree: '免费',
    planStandard: '标准',
    planAdvanced: '进阶',
    ...
    artifactPreviewCardLobsterBrowser: 'LfClaw 浏览器',
    artifactPreviewCardOpenInLobsterBrowser: '在LfClaw 浏览器中打开',
    ...
    coworkModelSettingsRequired: '正在连接企业 AI 服务，请稍后重试。',
    coworkModelSettingsTitle: '企业 AI 服务',
    coworkModelSettingsHint: 'LfClaw 使用企业 AI 服务中的当前模型与提供商配置。',
    coworkModelSettingsAction: '前往企业 AI 服务',
    modelGroupServer: '企业模型',
    modelGroupUser: '本地模型',
    modelSelectorCurrentModel: '当前使用',
    modelSelectorLockedOverlay: '企业版已固定模型',
    modelSelectorLockedModelHint: '选择企业模型前需先登录并订阅或购买加油包',
    modelSelectorLoginTitle: '企业模型',
    modelSelectorLoginDesc: '登录并订阅或购买加油包后即可使用企业模型',
    modelSelectorLoginBtn: '确定',
    modelSelectorSubscribeTitle: '企业模型',
    modelSelectorSubscribeDesc: '企业版已固定模型',
    modelSelectorSubscribeBtn: '确定',
    modelSelectorLearnMore: '',
    ...
    openClawRemoteGatewayTitle: '远程 OpenClaw 网关',
    openClawRemoteGatewayDesc: '让客户端连接公司服务器上的 OpenClaw Gateway。保存后重启应用生效。',
    openClawRemoteGatewayMode: '网关模式',
    openClawRemoteGatewayModeLocal: '本地',
    openClawRemoteGatewayModeRemote: '远程',
    openClawRemoteGatewayUrl: '网关地址',
    openClawRemoteGatewayToken: '网关令牌',
    openClawRemoteGatewayModel: '远程模型',
    openClawRemoteGatewayAllowInsecure: '允许非安全 WebSocket',
    openClawRemoteGatewayAllowInsecureDesc: '仅在可信测试网络使用；正式部署建议使用 HTTPS/WSS。',
    openClawRemoteGatewayConfigPath: '配置文件',
    openClawRemoteGatewaySave: '保存远程配置',
    openClawRemoteGatewaySaving: '正在保存...',
    openClawRemoteGatewaySaved: '远程网关配置已保存，重启应用后生效。',
    openClawRemoteGatewayLoadFailed: '远程网关配置读取失败',
    openClawRemoteGatewaySaveFailed: '远程网关配置保存失败',
    ...
    coworkApiProviderModel: '从企业 AI 服务选择',
    ...
    // 隐私协议弹窗
    privacyDialogTitle: 'LfClaw 企业内部使用说明',
    privacyDialogDesc: '使用 LfClaw 前，请阅读并确认{link}。',
    privacyDialogLinkText: 'LfClaw 企业内部使用说明',
    privacyDialogAccept: '我已阅读并同意',
    privacyDialogReject: '拒绝',
    welcomeTitle: '欢迎使用LfClaw',
    welcomeSubtitle: '超多AI功能等你探索～',
    welcomePromo: '新用户限时送百万Token',
    welcomeLogin: '登录',
    welcomeCustomModel: '本地模型',
  ...
  en: {
    ...
    copied: 'Copied',
    copyrightHolder: 'LfClaw Enterprise. All rights reserved.',
    ...
    authQuotaExhausted:
      'Enterprise AI service is unavailable. Please contact your administrator.',
    ...
    coworkModelSettingsRequired: 'Connecting to enterprise AI service. Please try again shortly.',
    coworkModelSettingsTitle: 'Enterprise AI Service',
    coworkModelSettingsHint:
      'LfClaw uses the current model and provider configuration from Enterprise AI Service.',
    coworkModelSettingsAction: 'Go to Enterprise AI Service',
    modelGroupServer: 'Enterprise Models',
    modelGroupUser: 'Local Models',
    ...
    openClawRemoteGatewayTitle: 'Remote OpenClaw Gateway',
    openClawRemoteGatewayDesc: 'Connect this client to the company OpenClaw Gateway. Restart the app after saving.',
    openClawRemoteGatewayMode: 'Gateway mode',
    openClawRemoteGatewayModeLocal: 'Local',
    openClawRemoteGatewayModeRemote: 'Remote',
    openClawRemoteGatewayUrl: 'Gateway URL',
    openClawRemoteGatewayToken: 'Gateway token',
    openClawRemoteGatewayModel: 'Remote model',
    openClawRemoteGatewayAllowInsecure: 'Allow insecure WebSocket',
    openClawRemoteGatewayAllowInsecureDesc: 'Use only on trusted test networks. Production deployments should use HTTPS/WSS.',
    openClawRemoteGatewayConfigPath: 'Config file',
    openClawRemoteGatewaySave: 'Save Remote Config',
    openClawRemoteGatewaySaving: 'Saving...',
    openClawRemoteGatewaySaved: 'Remote gateway config saved. Restart the app to apply it.',
    openClawRemoteGatewayLoadFailed: 'Failed to load remote gateway config',
    openClawRemoteGatewaySaveFailed: 'Failed to save remote gateway config',
    ...
    coworkWelcome: 'LfClaw',
    coworkDescription: 'Enterprise AI Assistant',
    ...
    coworkErrorQuotaExhausted:
      'Your credits have been used up. Upgrade your plan to continue.\n\n[Upgrade or recharge](https://bxz6lqekwy.feishu.cn/wiki/DHIgws6jkiizt1kOWsOcdr1jnSg)',
    coworkErrorFreeQuotaExhausted:
      'Your credits have been used up. Upgrade your plan to continue.\n\n[Upgrade or recharge](https://bxz6lqekwy.feishu.cn/wiki/DHIgws6jkiizt1kOWsOcdr1jnSg)',
    ...
    // Privacy dialog
    privacyDialogTitle: 'LfClaw Enterprise Terms',
    privacyDialogDesc:
      'Before using LfClaw, please read and confirm the {link}.',
    privacyDialogLinkText: 'LfClaw Enterprise Terms',
