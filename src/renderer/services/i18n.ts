...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    updatePreparingSafely: '正在保存数据并准备更新。如出现系统权限提示，请确认；取消后客户端会继续保留。更新将自动重启客户端。',
    shareConversation: '分享对话',
    shareInbox: '收到的分享',
    sharePrivacyNotice: '分享将包含当前对话的全部可见正文，以及对话中已有的附件；不上传系统提示词、工具日志、密钥配置或私人记忆。不支持部分分享，若含敏感内容请不要分享。分享后内容固定，不跟随原对话更新。',
    shareLinkMode: '生成链接',
    shareDirectMode: '发送给同事',
    shareLinkAccess: '链接由你自行通过微信、钉钉等发送。同一企业的有效账号持有链接即可查看，无有效期设置。',
    shareDirectAccess: '只有你和选中的接收人可以查看。对方升级到支持分享的客户端后可直接接收。',
    shareSearchRecipient: '搜索姓名或部门',
    shareSearchRecipientHint: '输入姓名或部门后显示匹配同事。',
    shareChooseRecipient: '请选择接收同事',
    shareNoRecipients: '没有可选同事。请确认企业服务已升级，且后台已添加其他有效员工。',
    shareRecipientNoMatch: '没有匹配的同事。',
    shareRecipientsSelected: '将发送给',
    shareEntireConversation: '将分享完整对话',
    shareConversationAttachments: '随对话自动分享的附件',
    shareNoConversationAttachments: '这段对话中没有附件。',
    shareCreateLink: '生成分享链接',
    shareSend: '发送分享',
    shareSent: '已发送，对方可在“收到的分享”中查看。',
    shareLinkCreated: '链接已生成，请通过你自己的联系方式发送。',
    shareLink: '分享链接',
    shareCopyLink: '复制链接',
    shareCopied: '已复制',
    shareCopyManually: '无法自动复制，请选中链接手动复制。',
    sharePasteLink: '粘贴分享链接以查看或接收',
    shareView: '查看',
    shareRefresh: '刷新',
    sharePreviousPage: '上一页',
    shareNextPage: '下一页',
    sharePage: '第',
    shareInboxTotal: '共',
    shareInboxItems: '条分享',
    shareInboxPerPage: '每页',
    shareDelete: '删除',
    shareDeleteConfirm: '确定从“收到的分享”中删除这条消息吗？已经接收并继续聊的本地对话不会被删除。',
    shareInboxEmpty: '暂无收到的分享。列表会自动刷新，也可以粘贴链接查看。',
    shareMessages: '条消息',
    shareUser: '用户',
    shareAssistant: '助手',
    shareContinueNotice: '接收后创建你的独立对话，并将历史上下文交给模型。使用你自己的模型与工具权限，不修改发送人的对话，也不同步后续消息。',
    shareReceiveContinue: '接收并继续聊',
    shareBackToInbox: '返回收到的分享',
    shareAttachment: '附件：',
    shareRequestFailed: '分享服务暂时不可用，请稍后重试。普通对话不受影响。',
    updateWorkspaceSaveFailed: '无法保存当前工作状态，已取消更新。请稍后重试。',
    // 通用
    save: '保存',
    cancel: '取消',
    saving: '保存中...',
    ...
    themeColor: '主题色',
    uiFontSize: 'UI 字号',
    uiFontSizeDescription: '调整 LFClaw 界面使用的基准字号',
    codeFontSize: '代码字体大小',
    ...
    shortcutDescNewChat: '开始一个新的 LFClaw 任务',
    shortcutDescFocusPrompt: '跳回 LFClaw 并聚焦当前输入框',
    ...
    shortcutDescOpenCowork: '切换到 LFClaw 任务视图',
    ...
    authQuotaExhausted:
      '今日免费额度已用完。您可以登录 LFClaw Portal 购买套餐或积分包继续使用，或在设置中配置自己的 API Key。',
    authTopUpLink: '充值',
    authSettingsLink: '设置',
    ...
    coworkWorkingDirectoryHint: 'LFClaw 将在此目录下执行命令',
    coworkSystemPrompt: '系统提示词',
    coworkSystemPromptPlaceholder: '为 LFClaw 设置自定义指令...',
    coworkSystemPromptHint: '可选的系统提示词，用于自定义 LFClaw 的行为',
    coworkModelSettingsRequired: '请先在模型设置中配置可用模型与 API Key。',
    coworkModelSettingsTitle: '模型设置',
    coworkModelSettingsHint: 'LFClaw 使用模型设置中的当前模型与提供商配置。',
    ...
    openClawDataBackupBlockingTitle: '正在备份 LFClaw 数据',
    ...
    openClawDataMigrationBlockingTitle: '正在准备导入 LFClaw 数据',
    ...
    openClawDataMigrationConfirmTitle: '导入 LFClaw 数据备份？',
    ...
    coworkConfigSaveFailed: '保存 LFClaw 配置失败，请稍后重试。',
    ...
    coworkPermissionDescription: 'LFClaw 请求执行以下操作',
    coworkSelectionRequired: '请选择',
    coworkSelectionDescription: 'LFClaw 需要你做出选择',
    coworkToolName: '工具名称',
    ...
    coworkHomeTagline: '我是 LFClaw，你的企业办公 Agent',
    ...
    coworkGoalInputPlaceholder: 'LFClaw 应继续朝哪个目标努力？',
    ...
    voiceInputEnterpriseRequired: '完成企业激活后可使用语音输入',
    voiceInputEnterpriseRequiredTitle: '请先完成企业激活',
    voiceInputEnterpriseRequiredDesc: '语音输入由企业服务统一提供，完成企业激活并由管理员配置语音服务后即可使用。',
    ...
    browserWebAccessDescription: '使用 LFClaw 独立浏览器，管理网页打开方式和访问规则。',
    ...
    browserProfileManagedDescription: 'LFClaw 启动一个专用浏览器，稳定、干净。',
    ...
    browserFollowGlobalProxyDescription: '默认开启。关闭后仅作为 LFClaw 配置保留，当前版本仍受浏览器自身代理设置影响。',
    ...
    browserBlockedHostnamesDescription: 'LFClaw 不会打开这些网站',
    browserHostnameListEmpty: '尚未添加域名',
    browserHostnameInputPlaceholder: 'example.com',
    browserAddBlockedHostnameTitle: '添加已屏蔽域名',
    browserAddBlockedHostnameDescription: '这意味着 LFClaw 不会打开此 URL',
    browserAddAllowedHostnameTitle: '添加允许域名',
    browserAddAllowedHostnameDescription: '这意味着 LFClaw 可以打开此域名',
    ...
    usageAnalyticsEnabled: '帮助改进 LFClaw',
    ...
    // 隐私协议弹窗
    privacyDialogTitle: '网易有道LFClaw服务协议',
    privacyDialogDesc: '在使用网易有道LFClaw之前，请您仔细阅读{link}内容，并进行确认。',
    privacyDialogLinkText: '网易有道LFClaw服务协议',
    privacyDialogAccept: '我已阅读并同意',
    privacyDialogReject: '拒绝',
    welcomeTitle: '欢迎使用 LFClaw',
    welcomeSubtitle: '超多AI功能等你探索～',
    welcomePromo: '企业激活后即可同步可用模型和积分',
    welcomeLogin: '登录',
  ...
  en: {
    updatePreparingSafely: 'Saving data and preparing the update. Confirm the system permission prompt if shown; cancelling keeps the client open. The update will restart the app automatically.',
    shareConversation: 'Share conversation',
    shareInbox: 'Received shares',
    sharePrivacyNotice: 'The share includes all visible message text and attachments already in this conversation. System prompts, tool logs, key configuration, and private memories are excluded. Partial sharing is not supported; do not share conversations containing sensitive content. The snapshot does not sync later changes.',
    shareLinkMode: 'Create a link',
    shareDirectMode: 'Send to colleagues',
    shareLinkAccess: 'Send the link using your own messaging app. Active accounts in your enterprise with the link can view it. No expiration is set.',
    shareDirectAccess: 'Only you and selected recipients can view it. Recipients can receive it in clients that support sharing.',
    shareSearchRecipient: 'Search name or department',
    shareSearchRecipientHint: 'Enter a name or department to show matching colleagues.',
    shareChooseRecipient: 'Select recipients',
    shareNoRecipients: 'No colleagues are available. Check that the enterprise server is updated and other active employees exist.',
    shareRecipientNoMatch: 'No matching colleagues.',
    shareRecipientsSelected: 'Sending to',
    shareEntireConversation: 'Entire conversation',
    shareConversationAttachments: 'Attachments included from this conversation',
    shareNoConversationAttachments: 'This conversation has no attachments.',
    shareCreateLink: 'Create share link',
    shareSend: 'Send share',
    shareSent: 'Sent. Recipients can find it in Received shares.',
    shareLinkCreated: 'Link created. Send it using your own messaging app.',
    shareLink: 'Share link',
    shareCopyLink: 'Copy link',
    shareCopied: 'Copied',
    shareCopyManually: 'Select the link and copy it manually.',
    sharePasteLink: 'Paste a share link to view or receive',
    shareView: 'View',
    shareRefresh: 'Refresh',
    sharePreviousPage: 'Previous',
    shareNextPage: 'Next',
    sharePage: 'Page',
    shareInboxTotal: 'Total',
    shareInboxItems: 'shares',
    shareInboxPerPage: 'Per page',
    shareDelete: 'Delete',
    shareDeleteConfirm: 'Delete this item from Received shares? Any local conversation you already received and continued will be kept.',
    shareInboxEmpty: 'No received shares. This list refreshes automatically. You can also paste a link.',
    shareMessages: 'messages',
    shareUser: 'User',
    shareAssistant: 'Assistant',
    shareContinueNotice: 'Receive your own conversation with the previous context available to the model. Use your own models and tool permissions. The sender’s conversation stays unchanged; later messages are not synced.',
    shareReceiveContinue: 'Receive and continue',
    shareBackToInbox: 'Back to received shares',
    shareAttachment: 'Attachment:',
    shareRequestFailed: 'Sharing is unavailable. Please retry later. Normal chat is unaffected.',
    updateWorkspaceSaveFailed: 'Could not save your workspace. Update cancelled; please try again.',
    // Common
    save: 'Save',
    cancel: 'Cancel',
    saving: 'Saving...',
    ...
    userGuideTitle: 'LFCLAW User Guide',
    userGuideOpen: 'Open Online Guide',
    userGuideOnlineHint: 'The guide is maintained online in Feishu Docs, so the latest version is always available.',
    userGuideOpenFailed: 'Unable to open the user guide. Please try again later.',
    about: 'About',
    ...
    uiFontSizeDescription: 'Adjust the base size used for the LFClaw UI',
    ...
    shortcutScopeHint: 'Shortcuts only run while the LFClaw window is focused; global shortcuts are ignored while editing text fields.',
    ...
    shortcutOpenCowork: 'Open LFClaw',
    ...
    shortcutDescNewChat: 'Start a new LFClaw task',
    shortcutDescFocusPrompt: 'Return to LFClaw and focus the current prompt',
    ...
    shortcutDescOpenCowork: 'Switch to the LFClaw task view',
    ...
    authQuotaExhausted:
      'Daily free quota exhausted. Visit LFClaw Portal to purchase a plan or credits, or configure your own API Key in Settings.',
    ...
    artifactPreviewCardLobsterBrowser: 'LFClaw Browser',
    artifactPreviewCardOpenInLobsterBrowser: 'Open in LFClaw Browser',
    ...
    // LFClaw
    cowork: 'LFClaw',
    coworkSettings: 'LFClaw Settings',
    ...
    coworkWorkingDirectoryHint: 'LFClaw will execute commands in this directory',
    coworkSystemPrompt: 'System Prompt',
    coworkSystemPromptPlaceholder: 'Set custom instructions for LFClaw...',
    coworkSystemPromptHint: "Optional system prompt to customize LFClaw's behavior",
    ...
    coworkModelSettingsHint:
      'LFClaw uses the current model and provider configuration from Model Settings.',
    ...
    openClawDataBackupBlockingTitle: 'Backing up LFClaw data',
    ...
    openClawDataMigrationBlockingTitle: 'Preparing to import LFClaw data',
    ...
    openClawDataMigrationConfirmTitle: 'Import LFClaw data backup?',
    ...
    coworkConfigSaveFailed: 'Failed to save LFClaw settings. Please try again.',
    ...
    coworkPermissionDescription: 'LFClaw is requesting to perform the following action',
    coworkSelectionRequired: 'Please Choose',
    coworkSelectionDescription: 'LFClaw needs your input',
    ...
    coworkHomeTagline: "I'm LFClaw, your enterprise office agent",
    ...
    coworkGoalInputPlaceholder: 'What goal should LFClaw keep working toward?',
    ...
    voiceInputEnterpriseRequired: 'Activate the enterprise account to use voice input',
    voiceInputEnterpriseRequiredTitle: 'Enterprise activation required',
    voiceInputEnterpriseRequiredDesc: 'Voice input is provided by the enterprise service. Activate the enterprise account and ask an admin to configure voice service before using it.',
    ...
    coworkGatewaySessionSyncTimeout:
      'The OpenClaw engine is responding slowly and your message has not been sent. Please wait a minute or two and resend. If this happens frequently, check system memory and disk usage, and add LFClaw to your antivirus allowlist.',
    ...
    browserWebAccessDescription: 'Use the LFClaw separate browser and manage page access rules.',
    ...
    browserProfileManagedDescription: 'LFClaw starts a dedicated browser that is stable and clean.',
    ...
    browserFollowGlobalProxyDescription: 'Enabled by default. Turning it off is stored for LFClaw, but this version can still be affected by the browser proxy settings.',
    ...
    browserBlockedHostnamesDescription: 'LFClaw will not open these websites',
    browserHostnameListEmpty: 'No domains added yet',
    browserHostnameInputPlaceholder: 'example.com',
    browserAddBlockedHostnameTitle: 'Add blocked domain',
    browserAddBlockedHostnameDescription: 'This means LFClaw will not open this URL',
    browserAddAllowedHostnameTitle: 'Add allowed domain',
    browserAddAllowedHostnameDescription: 'This means LFClaw can open this domain',
    ...
    usageAnalyticsEnabled: 'Help improve LFClaw',
    ...
    // Privacy dialog
    privacyDialogTitle: 'NetEase Youdao LFClaw Terms of Service',
    privacyDialogDesc:
      'Before using NetEase Youdao LFClaw, please carefully read the {link} and confirm.',
    privacyDialogLinkText: 'NetEase Youdao LFClaw Terms of Service',
    privacyDialogAccept: 'I have read and agree',
    privacyDialogReject: 'Decline',
    welcomeTitle: 'Welcome to LFClaw',
