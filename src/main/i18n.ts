 ...
 *   setLanguage('en');
 *   const label = t('trayShowWindow'); // "Open LfClaw"
...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    trayCompletedTaskTooltip: 'LfClaw - {count} 个任务已完成',
    traySettings: '设置',
    trayQuit: '退出',
    ...
    coworkGatewaySessionSyncTimeout: 'OpenClaw 引擎响应缓慢，消息尚未发送。请等待 1~2 分钟后重新发送；若频繁出现，请检查系统内存与磁盘占用，并将 LfClaw 加入杀毒软件白名单。',
    ...
    dataMigrationBackupDialogTitle: '备份 LfClaw 数据',
    dataMigrationRestoreDialogTitle: '导入 LfClaw 数据备份',
    dataMigrationBackupArchiveFilter: 'LfClaw 备份包',
    dataMigrationAllFilesFilter: '所有文件',
    dataMigrationBackupBlockedByActiveWorkloads:
      '当前有正在运行的 Agent 或定时任务，请停止或等待任务完成后再备份。',
    dataMigrationRestoreProgressTitle: '正在导入 LfClaw 数据',
  ...
  en: {
    ...
    trayCompletedTaskTooltip: 'LfClaw - {count} completed task(s)',
    ...
    coworkErrorQuotaExhausted:
      'The enterprise AI service is temporarily unavailable. Please contact your administrator.',
    coworkErrorFreeQuotaExhausted:
      'The enterprise AI service is temporarily unavailable. Please contact your administrator.',
    ...
    coworkGatewaySessionSyncTimeout: 'The OpenClaw engine is responding slowly and your message has not been sent. Please wait a minute or two and resend. If this happens frequently, check system memory and disk usage, and add LfClaw to your antivirus allowlist.',
    ...
    // Data migration dialogs
    dataMigrationBackupDialogTitle: 'Back Up LfClaw Data',
    dataMigrationRestoreDialogTitle: 'Import LfClaw Data Backup',
    dataMigrationBackupArchiveFilter: 'LfClaw Backup',
    ...
    dataMigrationRestoreProgressTitle: 'Importing LfClaw data',
    dataMigrationRestoreProgressDesc:
      'Restoring the backup and validating data. LfClaw will restart automatically when finished.',
